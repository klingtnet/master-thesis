...
$(OUT_PATH)/thesis.pdf: $(DOC_PATH)/text.tex
	...
	cd $(BUILD_PATH) && xelatex $(XELATEX_CI_OPTS) -no-pdf $(BUILD_PATH)/thesis
	cd $(BUILD_PATH) && biber $(BUILD_PATH)/thesis
	cd $(BUILD_PATH) && xelatex $(XELATEX_CI_OPTS) $(BUILD_PATH)/thesis
	cd $(BUILD_PATH) && cp $(BUILD_PATH)/thesis.pdf $(OUT_PATH)
